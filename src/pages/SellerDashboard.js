...
import { FaPlus, FaEdit, FaTrash, FaArrowLeft, FaUpload, FaImage, FaCheck, FaTimes, FaSignOutAlt, FaExclamationTriangle, FaChartLine, FaBoxOpen } from 'react-icons/fa';
...
const SellerDashboard = () => {
  ...
  // Handle stock update from inventory management
  const handleUpdateStock = async (productId, newStock) => {
    try {
      // Find the product to update
      const productToUpdate = products.find(p => p.id === productId || p._id === productId);
        ...
        <>
          <div className="dashboard-header">
            <div>
              ...
              <p>Welcome back, {sellerData?.name || 'Seller'}!</p>
            </div>
          ...
          {activeTab === 'statistics' && (
            <SellerStatistics products={products} />
          )}
